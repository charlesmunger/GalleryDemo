 ...
 * {@link ImageGridFragment} and the item details (if present) is a
 * {@link ImageDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link ImageGridFragment.Callbacks} interface to listen for item selections.
 */
public class ImageGridActivity extends FragmentActivity implements
		ImageGridFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.image_detail_container) != null) {
			...
			((ImageGridFragment) getSupportFragmentManager().findFragmentById(
	...
	/**
	 * Callback method from {@link ImageGridFragment.Callbacks} indicating that
