...
public class ImageGridFragment extends GridFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setGridAdapter(new ImageAdapter(getActivity().getApplicationContext()));
	}

	@Override
	public void onViewCreated(View view, Bundle savedInstanceState) {
		super.onViewCreated(view, savedInstanceState);
		super.getGridView().setColumnWidth(135);
		super.getGridView().setStretchMode(GridView.STRETCH_COLUMN_WIDTH);
		super.getGridView().setNumColumns(GridView.AUTO_FIT);
	...
	public void onGridItemClick(GridView listView, View view, int position,
		...
		mCallbacks.onItemSelected(ImageAdapter.mThumbIds[position].toString());
	}
